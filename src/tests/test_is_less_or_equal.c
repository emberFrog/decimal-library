...
START_TEST(test_is_less_or_equal_ok101) {
  ...
  my_decimal decimal2 = {{0xCEDBC273, 0x56AF422B, 0x981B561D, 0x801C0000}};
  int check = TEST_COMPARISON_FALSE;
...
START_TEST(test_is_less_or_equal_ok102) {
  // -4.7074769154693434325056864883
  my_decimal decimal1 = {{0xCEDBC273, 0x56AF422B, 0x981B561D, 0x801C0000}};
  // 79228162514264337593543950335
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  int check = TEST_COMPARISON_TRUE;
...
START_TEST(test_is_less_or_equal_ok103) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 4.7074769154693434325056864883
  my_decimal decimal2 = {{0xCEDBC273, 0x56AF422B, 0x981B561D, 0x1C0000}};
  int check = TEST_COMPARISON_FALSE;
...
START_TEST(test_is_less_or_equal_ok104) {
  // 4.7074769154693434325056864883
  my_decimal decimal1 = {{0xCEDBC273, 0x56AF422B, 0x981B561D, 0x1C0000}};
  // 79228162514264337593543950335
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  int check = TEST_COMPARISON_TRUE;
...
START_TEST(test_is_less_or_equal_ok105) {
  ...
  my_decimal decimal2 = {{0xCE5807BC, 0xF2D773B6, 0x4DB98FD2, 0x0}};
  int check = TEST_COMPARISON_FALSE;
...
START_TEST(test_is_less_or_equal_ok106) {
  // 24054676222594164633554651068
  my_decimal decimal1 = {{0xCE5807BC, 0xF2D773B6, 0x4DB98FD2, 0x0}};
  // 79228162514264337593543950335
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  int check = TEST_COMPARISON_TRUE;
...
START_TEST(test_is_less_or_equal_ok107) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -24054676222594164633554651068
  my_decimal decimal2 = {{0xCE5807BC, 0xF2D773B6, 0x4DB98FD2, 0x80000000}};
  int check = TEST_COMPARISON_FALSE;
...
START_TEST(test_is_less_or_equal_ok108) {
  // -24054676222594164633554651068
  my_decimal decimal1 = {{0xCE5807BC, 0xF2D773B6, 0x4DB98FD2, 0x80000000}};
  // 79228162514264337593543950335
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  int check = TEST_COMPARISON_TRUE;
...
START_TEST(test_is_less_or_equal_ok109) {
  ...
  my_decimal decimal2 = {{0xE333C1D3, 0xC173E715, 0x631797E3, 0xF0000}};
  int check = TEST_COMPARISON_FALSE;
...
START_TEST(test_is_less_or_equal_ok110) {
  // 30667538544853.855676101018067
  my_decimal decimal1 = {{0xE333C1D3, 0xC173E715, 0x631797E3, 0xF0000}};
  // 79228162514264337593543950335
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  int check = TEST_COMPARISON_TRUE;
...
START_TEST(test_is_less_or_equal_ok111) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -30667538544853.855676101018067
  my_decimal decimal2 = {{0xE333C1D3, 0xC173E715, 0x631797E3, 0x800F0000}};
  int check = TEST_COMPARISON_FALSE;
...
START_TEST(test_is_less_or_equal_ok112) {
  // -30667538544853.855676101018067
  my_decimal decimal1 = {{0xE333C1D3, 0xC173E715, 0x631797E3, 0x800F0000}};
  // 79228162514264337593543950335
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  int check = TEST_COMPARISON_TRUE;
...
void test_is_less_or_equal(my_decimal decimal1, my_decimal decimal2,
                           int check) {
  int code = my_is_less_or_equal(decimal1, decimal2);
