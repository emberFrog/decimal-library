...
START_TEST(test_mod_fail_manual1) {
  ...
  int code = my_mod(decimal1, decimal2, NULL);
...
START_TEST(test_mod_fail_manual2) {
  ...
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
  my_decimal result;
  int code = my_mod(decimal1, decimal2, &result);
...
START_TEST(test_mod_manual1) {
  ...
  // 0.0000012345
  my_decimal decimal2 = {{0x3039, 0x0, 0x0, 0xA0000}};
  // 0.0000002880
  my_decimal decimal_check = {{0xB40, 0x0, 0x0, 0xA0000}};
...
START_TEST(test_mod_manual2) {
  ...
  my_decimal decimal2 = {{0x3, 0x0, 0x0, 0x1C0000}};
...
START_TEST(test_mod_manual3) {
  ...
  my_decimal decimal2 = {{0xD80, 0x0, 0x0, 0x1C0000}};
  // 0.0000000000000000000000002304
  my_decimal decimal_check = {{0x900, 0x0, 0x0, 0x1C0000}};
...
START_TEST(test_mod_manual4) {
  ...
  my_decimal decimal1 = {{0x8707, 0x0, 0x0, 0x1C0000}};
  // -0.0000000000000000000000001234
  my_decimal decimal2 = {{0x4D2, 0x0, 0x0, 0x801C0000}};
...
START_TEST(test_mod_manual5) {
  ...
  my_decimal decimal1 = {{0x571C71C7, 0x6E7AAEE, 0x39716EE, 0x801C0000}};
  // -0.0100000002000000030000000004
  my_decimal decimal2 = {{0x2EEBAC04, 0xF8897A41, 0x52B7D2, 0x801C0000}};
  // -0.0011111089111110781111111067
  my_decimal decimal_check = {{0x52FC0D9B, 0x58FF6A21, 0x930DD, 0x801C0000}};
...
START_TEST(test_mod_manual6) {
  ...
  my_decimal decimal1 = {{0x571C71C7, 0x6E7AAEE, 0x39716EE, 0x801C0000}};
  // 0.01
  my_decimal decimal2 = {{0x1, 0x0, 0x0, 0x20000}};
  // -0.0011111111111111111111111111
  my_decimal decimal_check = {{0x8B1C71C7, 0x8A4F1DDE, 0x930DE, 0x801C0000}};
...
START_TEST(test_mod_manual7) {
  ...
  my_decimal decimal2 = {{0x10000001, 0x3E250261, 0x204FCE5E, 0x1A0000}};
  // 27.07718374857356624064560497
  my_decimal decimal_check = {{0x30A3D71, 0x39973179, 0x8BFC5AB, 0x1A0000}};
...
START_TEST(test_mod_manual100) {
  // 4294967296
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.1
  my_decimal decimal2 = {{0xB, 0x0, 0x0, 0x10000}};
  // 0.7
  my_decimal decimal_check = {{0x7, 0x0, 0x0, 0x10000}};
...
START_TEST(test_mod_manual101) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.01
  my_decimal decimal2 = {{0x65, 0x0, 0x0, 0x20000}};
  // 0.33
  my_decimal decimal_check = {{0x21, 0x0, 0x0, 0x20000}};
...
START_TEST(test_mod_manual102) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.001
  my_decimal decimal2 = {{0x3E9, 0x0, 0x0, 0x30000}};
  // 0.381
  my_decimal decimal_check = {{0x17D, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod_manual103) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.0001
  my_decimal decimal2 = {{0x2711, 0x0, 0x0, 0x40000}};
  // 0.2158
  my_decimal decimal_check = {{0x86E, 0x0, 0x0, 0x40000}};
...
START_TEST(test_mod_manual104) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.00001
  my_decimal decimal2 = {{0x186A1, 0x0, 0x0, 0x50000}};
  // 0.75654
  my_decimal decimal_check = {{0x12786, 0x0, 0x0, 0x50000}};
...
START_TEST(test_mod_manual105) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.000001
  my_decimal decimal2 = {{0xF4241, 0x0, 0x0, 0x60000}};
  // 0.036999
  my_decimal decimal_check = {{0x9087, 0x0, 0x0, 0x60000}};
...
START_TEST(test_mod_manual106) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.0000001
  my_decimal decimal2 = {{0x989681, 0x0, 0x0, 0x70000}};
  // 0.5033134
  my_decimal decimal_check = {{0x4CCCAE, 0x0, 0x0, 0x70000}};
...
START_TEST(test_mod_manual107) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.00000001
  my_decimal decimal2 = {{0x5F5E101, 0x0, 0x0, 0x80000}};
  // 0.05032747
  my_decimal decimal_check = {{0x4CCB2B, 0x0, 0x0, 0x80000}};
...
START_TEST(test_mod_manual108) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.000000001
  my_decimal decimal2 = {{0x3B9ACA01, 0x0, 0x0, 0x90000}};
  // 0.705032709
  my_decimal decimal_check = {{0x2A05F205, 0x0, 0x0, 0x90000}};
...
START_TEST(test_mod_manual109) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.0000000001
  my_decimal decimal2 = {{0x540BE401, 0x2, 0x0, 0xA0000}};
  // 0.5705032705
  my_decimal decimal_check = {{0x540BE401, 0x1, 0x0, 0xA0000}};
...
START_TEST(test_mod_manual110) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.00000000001
  my_decimal decimal2 = {{0x4876E801, 0x17, 0x0, 0xB0000}};
  // 0.95705032705
  my_decimal decimal_check = {{0x4876E801, 0x16, 0x0, 0xB0000}};
...
START_TEST(test_mod_manual111) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.000000000001
  my_decimal decimal2 = {{0xD4A51001, 0xE8, 0x0, 0xC0000}};
  // 0.995705032705
  my_decimal decimal_check = {{0xD4A51001, 0xE7, 0x0, 0xC0000}};
...
START_TEST(test_mod_manual112) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.0000000000001
  my_decimal decimal2 = {{0x4E72A001, 0x918, 0x0, 0xD0000}};
  // 0.9995705032705
  my_decimal decimal_check = {{0x4E72A001, 0x917, 0x0, 0xD0000}};
...
START_TEST(test_mod_manual113) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.00000000000001
  my_decimal decimal2 = {{0x107A4001, 0x5AF3, 0x0, 0xE0000}};
  // 0.99995705032705
  my_decimal decimal_check = {{0x107A4001, 0x5AF2, 0x0, 0xE0000}};
...
START_TEST(test_mod_manual114) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.000000000000001
  my_decimal decimal2 = {{0xA4C68001, 0x38D7E, 0x0, 0xF0000}};
  // 0.999995705032705
  my_decimal decimal_check = {{0xA4C68001, 0x38D7D, 0x0, 0xF0000}};
...
START_TEST(test_mod_manual115) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.0000000000000001
  my_decimal decimal2 = {{0x6FC10001, 0x2386F2, 0x0, 0x100000}};
  // 0.9999995705032705
  my_decimal decimal_check = {{0x6FC10001, 0x2386F1, 0x0, 0x100000}};
...
START_TEST(test_mod_manual116) {
  ...
  my_decimal decimal1 = {{0x0, 0x1, 0x0, 0x0}};
  // 1.00000000000000001
  my_decimal decimal2 = {{0x5D8A0001, 0x1634578, 0x0, 0x110000}};
  // 0.99999995705032705
  my_decimal decimal_check = {{0x5D8A0001, 0x1634577, 0x0, 0x110000}};
...
START_TEST(test_mod_manual117) {
  ...
  my_decimal decimal2 = {{0xA7640001, 0xDE0B6B3, 0x0, 0x120000}};
  // 0.999999995705032705
  my_decimal decimal_check = {{0xA7640001, 0xDE0B6B2, 0x0, 0x120000}};
...
START_TEST(test_mod_manual118) {
  ...
  my_decimal decimal2 = {{0x89E80001, 0x8AC72304, 0x0, 0x130000}};
  // 0.9999999995705032705
  my_decimal decimal_check = {{0x89E80001, 0x8AC72303, 0x0, 0x130000}};
...
START_TEST(test_mod_manual119) {
  ...
  my_decimal decimal2 = {{0x63100001, 0x6BC75E2D, 0x5, 0x140000}};
  // 0.99999999995705032705
  my_decimal decimal_check = {{0x63100001, 0x6BC75E2C, 0x5, 0x140000}};
...
START_TEST(test_mod_manual120) {
  ...
  my_decimal decimal2 = {{0xDEA00001, 0x35C9ADC5, 0x36, 0x150000}};
  // 0.999999999995705032705
  my_decimal decimal_check = {{0xDEA00001, 0x35C9ADC4, 0x36, 0x150000}};
...
START_TEST(test_mod_manual121) {
  ...
  my_decimal decimal2 = {{0xB2400001, 0x19E0C9BA, 0x21E, 0x160000}};
  // 0.9999999999995705032705
  my_decimal decimal_check = {{0xB2400001, 0x19E0C9B9, 0x21E, 0x160000}};
...
START_TEST(test_mod_manual122) {
  ...
  my_decimal decimal2 = {{0xF6800001, 0x2C7E14A, 0x152D, 0x170000}};
  // 0.99999999999995705032705
  my_decimal decimal_check = {{0xF6800001, 0x2C7E149, 0x152D, 0x170000}};
...
START_TEST(test_mod_manual123) {
  ...
  my_decimal decimal2 = {{0xA1000001, 0x1BCECCED, 0xD3C2, 0x180000}};
  // 0.999999999999995705032705
  my_decimal decimal_check = {{0xA1000001, 0x1BCECCEC, 0xD3C2, 0x180000}};
...
START_TEST(test_mod_manual124) {
  ...
  my_decimal decimal2 = {{0x4A000001, 0x16140148, 0x84595, 0x190000}};
  // 0.9999999999999995705032705
  my_decimal decimal_check = {{0x4A000001, 0x16140147, 0x84595, 0x190000}};
...
START_TEST(test_mod_manual125) {
  ...
  my_decimal decimal2 = {{0xE4000001, 0xDCC80CD2, 0x52B7D2, 0x1A0000}};
  // 0.99999999999999995705032705
  my_decimal decimal_check = {{0xE4000001, 0xDCC80CD1, 0x52B7D2, 0x1A0000}};
...
START_TEST(test_mod_manual126) {
  ...
  my_decimal decimal2 = {{0xE8000001, 0x9FD0803C, 0x33B2E3C, 0x1B0000}};
  // 0.999999999999999995705032705
  my_decimal decimal_check = {{0xE8000001, 0x9FD0803B, 0x33B2E3C, 0x1B0000}};
...
START_TEST(test_mod_manual127) {
  ...
  my_decimal decimal_check = {{0x10000001, 0x3E250260, 0x204FCE5E, 0x1C0000}};
...
START_TEST(test_mod_manual200) {
  ...
  my_decimal decimal2 = {{0xB, 0x0, 0x0, 0x10000}};
  // 0.3
  my_decimal decimal_check = {{0x3, 0x0, 0x0, 0x10000}};
...
START_TEST(test_mod_manual201) {
  ...
  my_decimal decimal2 = {{0x65, 0x0, 0x0, 0x20000}};
  // 0.83
  my_decimal decimal_check = {{0x53, 0x0, 0x0, 0x20000}};
...
START_TEST(test_mod_manual202) {
  ...
  my_decimal decimal2 = {{0x3E9, 0x0, 0x0, 0x30000}};
  // 0.091
  my_decimal decimal_check = {{0x5B, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod_manual203) {
  ...
  my_decimal decimal2 = {{0x2711, 0x0, 0x0, 0x40000}};
  // 0.3441
  my_decimal decimal_check = {{0xD71, 0x0, 0x0, 0x40000}};
...
START_TEST(test_mod_manual204) {
  ...
  my_decimal decimal2 = {{0x186A1, 0x0, 0x0, 0x50000}};
  // 0.91908
  my_decimal decimal_check = {{0x16704, 0x0, 0x0, 0x50000}};
...
START_TEST(test_mod_manual205) {
  ...
  my_decimal decimal2 = {{0xF4241, 0x0, 0x0, 0x60000}};
  // 0.462158
  my_decimal decimal_check = {{0x70D4E, 0x0, 0x0, 0x60000}};
...
START_TEST(test_mod_manual206) {
  ...
  my_decimal decimal2 = {{0x989681, 0x0, 0x0, 0x70000}};
  // 0.3894531
  my_decimal decimal_check = {{0x3B6D03, 0x0, 0x0, 0x70000}};
...
START_TEST(test_mod_manual207) {
  ...
  my_decimal decimal2 = {{0x5F5E101, 0x0, 0x0, 0x80000}};
  // 0.83253403
  my_decimal decimal_check = {{0x4F6589B, 0x0, 0x0, 0x80000}};
...
START_TEST(test_mod_manual208) {
  ...
  my_decimal decimal2 = {{0x3B9ACA01, 0x0, 0x0, 0x90000}};
  // 0.492224824
  my_decimal decimal_check = {{0x1D56C138, 0x0, 0x0, 0x90000}};
...
START_TEST(test_mod_manual209) {
  ...
  my_decimal decimal2 = {{0x540BE401, 0x2, 0x0, 0xA0000}};
  // 0.7090201800
  my_decimal decimal_check = {{0xA69BE4C8, 0x1, 0x0, 0xA0000}};
...
START_TEST(test_mod_manual210) {
  ...
  my_decimal decimal2 = {{0x4876E801, 0x17, 0x0, 0xB0000}};
  // 0.31590770225
  my_decimal decimal_check = {{0x5AF4E631, 0x7, 0x0, 0xB0000}};
...
START_TEST(test_mod_manual211) {
  ...
  my_decimal decimal2 = {{0xD4A51001, 0xE8, 0x0, 0xC0000}};
  // 0.568970234775
  my_decimal decimal_check = {{0x7944CB97, 0x84, 0x0, 0xC0000}};
...
START_TEST(test_mod_manual212) {
  ...
  my_decimal decimal2 = {{0x4E72A001, 0x918, 0x0, 0xD0000}};
  // 0.5222707475307
  my_decimal decimal_check = {{0x19FB36B, 0x4C0, 0x0, 0xD0000}};
...
START_TEST(test_mod_manual213) {
  ...
  my_decimal decimal2 = {{0x107A4001, 0x5AF3, 0x0, 0xE0000}};
  // 0.54688081192301
  my_decimal decimal_check = {{0xFA7256D, 0x31BD, 0x0, 0xE0000}};
...
START_TEST(test_mod_manual214) {
  ...
  my_decimal decimal2 = {{0xA4C68001, 0x38D7E, 0x0, 0xF0000}};
  // 0.741634618563930
  my_decimal decimal_check = {{0x43FE1D5A, 0x2A283, 0x0, 0xF0000}};
...
START_TEST(test_mod_manual215) {
  ...
  my_decimal decimal2 = {{0x6FC10001, 0x2386F2, 0x0, 0x100000}};
  // 0.5670329272301092
  my_decimal decimal_check = {{0x6A08F624, 0x142522, 0x0, 0x100000}};
...
START_TEST(test_mod_manual216) {
  ...
  my_decimal decimal2 = {{0x5D8A0001, 0x1634578, 0x0, 0x110000}};
  // 0.35663198737674808
  my_decimal decimal_check = {{0x84503238, 0x7EB37D, 0x0, 0x110000}};
...
START_TEST(test_mod_manual217) {
  ...
  my_decimal decimal_check = {{0xDC9D1D4, 0xA359922, 0x0, 0x120000}};
...
START_TEST(test_mod_manual218) {
  ...
  my_decimal decimal_check = {{0xB89C94FD, 0x4F992A93, 0x0, 0x130000}};
...
START_TEST(test_mod9) {
  ...
  my_decimal decimal2 = {{0x80000000, 0x0, 0x80000000, 0x0}};
  // 39614081257132168794624491519
  my_decimal decimal_check = {{0x7FFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF, 0x0}};
...
START_TEST(test_mod10) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -39614081257132168798919458816
  my_decimal decimal2 = {{0x80000000, 0x0, 0x80000000, 0x80000000}};
  // 39614081257132168794624491519
  my_decimal decimal_check = {{0x7FFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF, 0x0}};
...
START_TEST(test_mod11) {
  ...
  my_decimal decimal2 = {{0x0, 0x0, 0x80000000, 0x0}};
  // 39614081257132168796771975167
  my_decimal decimal_check = {{0xFFFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF, 0x0}};
...
START_TEST(test_mod12) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -39614081257132168796771975168
  my_decimal decimal2 = {{0x0, 0x0, 0x80000000, 0x80000000}};
  // 39614081257132168796771975167
  my_decimal decimal_check = {{0xFFFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF, 0x0}};
...
START_TEST(test_mod13) {
  ...
  my_decimal decimal_check = {{0xF0000000, 0xC1DAFD9E, 0x5FB031A1, 0x1C0000}};
...
START_TEST(test_mod14) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -3.9614081257132168796771975168
  my_decimal decimal2 = {{0x0, 0x0, 0x80000000, 0x801C0000}};
  // 2.9614081257132168796771975168
  my_decimal decimal_check = {{0xF0000000, 0xC1DAFD9E, 0x5FB031A1, 0x1C0000}};
...
START_TEST(test_mod15) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 4294967297
  my_decimal decimal2 = {{0x1, 0x1, 0x0, 0x0}};
  // 4294967295
...
START_TEST(test_mod16) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -4294967297
  my_decimal decimal2 = {{0x1, 0x1, 0x0, 0x80000000}};
  // 4294967295
  my_decimal decimal_check = {{0xFFFFFFFF, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod17) {
  ...
  my_decimal decimal2 = {{0xFFFFFFFF, 0x0, 0xFFFFFFFF, 0x0}};
...
START_TEST(test_mod18) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -79228162495817593524129366015
  my_decimal decimal2 = {{0xFFFFFFFF, 0x0, 0xFFFFFFFF, 0x80000000}};
  // 18446744069414584320
  my_decimal decimal_check = {{0x0, 0xFFFFFFFF, 0x0, 0x0}};
...
START_TEST(test_mod19) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 4294967296
  my_decimal decimal2 = {{0x0, 0x1, 0x0, 0x0}};
  // 4294967295
  my_decimal decimal_check = {{0xFFFFFFFF, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod20) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -4294967296
  my_decimal decimal2 = {{0x0, 0x1, 0x0, 0x80000000}};
  // 4294967295
  my_decimal decimal_check = {{0xFFFFFFFF, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod21) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 2147483648
  my_decimal decimal2 = {{0x80000000, 0x0, 0x0, 0x0}};
  // 2147483647
...
START_TEST(test_mod22) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -2147483648
  my_decimal decimal2 = {{0x80000000, 0x0, 0x0, 0x80000000}};
  // 2147483647
  my_decimal decimal_check = {{0x7FFFFFFF, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod23) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 8589934591
  my_decimal decimal2 = {{0xFFFFFFFF, 0x1, 0x0, 0x0}};
  // 1073741823
  my_decimal decimal_check = {{0x3FFFFFFF, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod24) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -8589934591
  my_decimal decimal2 = {{0xFFFFFFFF, 0x1, 0x0, 0x80000000}};
  // 1073741823
  my_decimal decimal_check = {{0x3FFFFFFF, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod25) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 5
  my_decimal decimal2 = {{0x5, 0x0, 0x0, 0x0}};
  // 0
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod26) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -5
  my_decimal decimal2 = {{0x5, 0x0, 0x0, 0x80000000}};
  // 0
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod27) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 2
  my_decimal decimal2 = {{0x2, 0x0, 0x0, 0x0}};
  // 1
  my_decimal decimal_check = {{0x1, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod28) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -2
  my_decimal decimal2 = {{0x2, 0x0, 0x0, 0x80000000}};
  // 1
  my_decimal decimal_check = {{0x1, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod29) {
  ...
  my_decimal decimal_check = {{0x701E3660, 0x755E302F, 0xD2FEFD0, 0x1C0000}};
...
START_TEST(test_mod31) {
  ...
  my_decimal decimal2 = {{0x1FFFFFFF, 0x7C4A04C2, 0x409F9CBC, 0x1C0000}};
  // 0.9614081257132168796771975169
  my_decimal decimal_check = {{0xD0000001, 0x4590F8DC, 0x1F1094E5, 0x1C0000}};
...
START_TEST(test_mod32) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -1.9999999999999999999999999999
  my_decimal decimal2 = {{0x1FFFFFFF, 0x7C4A04C2, 0x409F9CBC, 0x801C0000}};
  // 0.9614081257132168796771975169
  my_decimal decimal_check = {{0xD0000001, 0x4590F8DC, 0x1F1094E5, 0x1C0000}};
...
START_TEST(test_mod35) {
  ...
  my_decimal decimal2 = {{0x8, 0x0, 0x0, 0x1C0000}};
  // 0.0000000000000000000000000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x1C0000}};
...
START_TEST(test_mod36) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -0.0000000000000000000000000008
  my_decimal decimal2 = {{0x8, 0x0, 0x0, 0x801C0000}};
  // 0.0000000000000000000000000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x1C0000}};
...
START_TEST(test_mod41) {
  ...
  my_decimal decimal_check = {{0x90000006, 0x4CFCEF58, 0x1DD15B6C, 0x1C0000}};
...
START_TEST(test_mod45) {
  ...
  my_decimal decimal2 = {{0x60000005, 0x74DE0E46, 0xC1DED635, 0x1B0000}};
  // 8.397653123811305200538004140
  my_decimal decimal_check = {{0x42AAAAAC, 0x7E22E3C, 0x1B226038, 0x1B0000}};
...
START_TEST(test_mod46) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -60.000000000000000000000000005
  my_decimal decimal2 = {{0x60000005, 0x74DE0E46, 0xC1DED635, 0x801B0000}};
  // 8.397653123811305200538004140
  my_decimal decimal_check = {{0x42AAAAAC, 0x7E22E3C, 0x1B226038, 0x1B0000}};
...
START_TEST(test_mod49) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 0.001
  my_decimal decimal2 = {{0x1, 0x0, 0x0, 0x30000}};
  // 0.000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod50) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -0.001
  my_decimal decimal2 = {{0x1, 0x0, 0x0, 0x80030000}};
  // 0.000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod51) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 0.019
  my_decimal decimal2 = {{0x13, 0x0, 0x0, 0x30000}};
  // 0.015
  my_decimal decimal_check = {{0xF, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod52) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -0.019
  my_decimal decimal2 = {{0x13, 0x0, 0x0, 0x80030000}};
  // 0.015
  my_decimal decimal_check = {{0xF, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod53) {
  ...
  my_decimal decimal2 = {{0x80000000, 0x80000000, 0x80000000, 0xF0000}};
  // 28232649134943.668301643481088
  my_decimal decimal_check = {{0x5B398000, 0x5B398000, 0x5B398000, 0xF0000}};
...
START_TEST(test_mod54) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -39614081266355.540835774234624
  my_decimal decimal2 = {{0x80000000, 0x80000000, 0x80000000, 0x800F0000}};
  // 28232649134943.668301643481088
  my_decimal decimal_check = {{0x5B398000, 0x5B398000, 0x5B398000, 0xF0000}};
...
START_TEST(test_mod55) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 42.94967296
  my_decimal decimal2 = {{0x0, 0x1, 0x0, 0x80000}};
  // 41.94967296
  my_decimal decimal_check = {{0xFA0A1F00, 0x0, 0x0, 0x80000}};
...
START_TEST(test_mod56) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -42.94967296
  my_decimal decimal2 = {{0x0, 0x1, 0x0, 0x80080000}};
  // 41.94967296
  my_decimal decimal_check = {{0xFA0A1F00, 0x0, 0x0, 0x80000}};
...
START_TEST(test_mod57) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 214748.3648
  my_decimal decimal2 = {{0x80000000, 0x0, 0x0, 0x40000}};
  // 214747.3648
  my_decimal decimal_check = {{0x7FFFD8F0, 0x0, 0x0, 0x40000}};
...
START_TEST(test_mod58) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -214748.3648
  my_decimal decimal2 = {{0x80000000, 0x0, 0x0, 0x80040000}};
  // 214747.3648
  my_decimal decimal_check = {{0x7FFFD8F0, 0x0, 0x0, 0x40000}};
...
START_TEST(test_mod59) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 42.94967295
  my_decimal decimal2 = {{0xFFFFFFFF, 0x0, 0x0, 0x80000}};
  // 0.00000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x80000}};
...
START_TEST(test_mod60) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -42.94967295
  my_decimal decimal2 = {{0xFFFFFFFF, 0x0, 0x0, 0x80080000}};
  // 0.00000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x80000}};
...
START_TEST(test_mod61) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 0.9999
  my_decimal decimal2 = {{0x270F, 0x0, 0x0, 0x40000}};
  // 0.7290
  my_decimal decimal_check = {{0x1C7A, 0x0, 0x0, 0x40000}};
...
START_TEST(test_mod62) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -0.9999
  my_decimal decimal2 = {{0x270F, 0x0, 0x0, 0x80040000}};
  // 0.7290
  my_decimal decimal_check = {{0x1C7A, 0x0, 0x0, 0x40000}};
...
START_TEST(test_mod63) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 1.431655765
  my_decimal decimal2 = {{0x55555555, 0x0, 0x0, 0x90000}};
  // 0.000000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x90000}};
...
START_TEST(test_mod64) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -1.431655765
  my_decimal decimal2 = {{0x55555555, 0x0, 0x0, 0x80090000}};
  // 0.000000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x90000}};
...
START_TEST(test_mod65) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 8460.288
  my_decimal decimal2 = {{0x811800, 0x0, 0x0, 0x30000}};
  // 7044.120
  my_decimal decimal_check = {{0x6B7C18, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod66) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -8460.288
  my_decimal decimal2 = {{0x811800, 0x0, 0x0, 0x80030000}};
  // 7044.120
  my_decimal decimal_check = {{0x6B7C18, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod67) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 8.000
  my_decimal decimal2 = {{0x1F40, 0x0, 0x0, 0x30000}};
  // 7.000
  my_decimal decimal_check = {{0x1B58, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod68) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -8.000
  my_decimal decimal2 = {{0x1F40, 0x0, 0x0, 0x80030000}};
  // 7.000
  my_decimal decimal_check = {{0x1B58, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod70) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -1.001
  my_decimal decimal2 = {{0x3E9, 0x0, 0x0, 0x80030000}};
  // 0.091
  my_decimal decimal_check = {{0x5B, 0x0, 0x0, 0x30000}};
...
START_TEST(test_mod73) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 10
  my_decimal decimal2 = {{0xA, 0x0, 0x0, 0x0}};
  // 5
...
START_TEST(test_mod74) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -10
  my_decimal decimal2 = {{0xA, 0x0, 0x0, 0x80000000}};
  // 5
  my_decimal decimal_check = {{0x5, 0x0, 0x0, 0x0}};
...
START_TEST(test_mod79) {
  ...
  my_decimal decimal2 = {{0x43114BD, 0x948E9182, 0x6C897447, 0x70000}};
  // 2834584564307424183811.2473691
  my_decimal decimal_check = {{0x9376825B, 0x5BA570D3, 0x5B97224B, 0x70000}};
...
START_TEST(test_mod80) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -3359055301292796708334.2402749
  my_decimal decimal2 = {{0x43114BD, 0x948E9182, 0x6C897447, 0x80070000}};
  // 2834584564307424183811.2473691
  my_decimal decimal_check = {{0x9376825B, 0x5BA570D3, 0x5B97224B, 0x70000}};
...
START_TEST(test_mod81) {
  ...
  my_decimal decimal2 = {{0x85B0C672, 0x31FBFF52, 0x5EA74437, 0x80000000}};
  // 20640555165913154035317109531
  my_decimal decimal_check = {{0xF49E731B, 0x9C08015A, 0x42B17791, 0x0}};
...
START_TEST(test_mod82) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 29293803674175591779113420402
  my_decimal decimal2 = {{0x85B0C672, 0x31FBFF52, 0x5EA74437, 0x0}};
  // 20640555165913154035317109531
  my_decimal decimal_check = {{0xF49E731B, 0x9C08015A, 0x42B17791, 0x0}};
...
START_TEST(test_mod83) {
  ...
  my_decimal decimal2 = {{0x29675E79, 0x78DCFEE6, 0x536BB048, 0x180000}};
  // 24274.269098408429436559324273
  my_decimal decimal_check = {{0xAE567471, 0x997FEE25, 0x4E6F346C, 0x180000}};
...
START_TEST(test_mod84) {
  ...
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -25817.443351246080434413985401
  my_decimal decimal2 = {{0x29675E79, 0x78DCFEE6, 0x536BB048, 0x80180000}};
  // 24274.269098408429436559324273
  my_decimal decimal_check = {{0xAE567471, 0x997FEE25, 0x4E6F346C, 0x180000}};
...
START_TEST(test_mod107) {
  ...
  my_decimal decimal2 = {{0xFFFFFFFF, 0x1, 0x0, 0x0}};
  // -1073741823
  my_decimal decimal_check = {{0x3FFFFFFF, 0x0, 0x0, 0x80000000}};
...
START_TEST(test_mod113) {
  ...
  my_decimal decimal2 = {{0x1FFFFC18, 0x7C4A04C2, 0x409F9CBC, 0x1C0000}};
  // -0.4081257132168796771977148000
  my_decimal decimal_check = {{0x701E3660, 0x755E302F, 0xD2FEFD0, 0x801C0000}};
...
START_TEST(test_mod129) {
  ...
  my_decimal decimal2 = {{0x60000005, 0x74DE0E46, 0xC1DED635, 0x1B0000}};
  // -8.397653123811305200538004140
  my_decimal decimal_check = {{0x42AAAAAC, 0x7E22E3C, 0x1B226038, 0x801B0000}};
...
START_TEST(test_mod133) {
  ...
  my_decimal decimal2 = {{0x1, 0x0, 0x0, 0x30000}};
  // -0.000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x80030000}};
...
START_TEST(test_mod135) {
  ...
  my_decimal decimal2 = {{0x13, 0x0, 0x0, 0x30000}};
  // -0.015
  my_decimal decimal_check = {{0xF, 0x0, 0x0, 0x80030000}};
...
START_TEST(test_mod139) {
  ...
  my_decimal decimal2 = {{0x0, 0x1, 0x0, 0x80000}};
  // -41.94967296
  my_decimal decimal_check = {{0xFA0A1F00, 0x0, 0x0, 0x80080000}};
...
START_TEST(test_mod141) {
  ...
  my_decimal decimal2 = {{0x80000000, 0x0, 0x0, 0x40000}};
  // -214747.3648
  my_decimal decimal_check = {{0x7FFFD8F0, 0x0, 0x0, 0x80040000}};
...
START_TEST(test_mod143) {
  ...
  my_decimal decimal2 = {{0xFFFFFFFF, 0x0, 0x0, 0x80000}};
  // -0.00000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x80080000}};
...
START_TEST(test_mod145) {
  ...
  my_decimal decimal2 = {{0x270F, 0x0, 0x0, 0x40000}};
  // -0.7290
  my_decimal decimal_check = {{0x1C7A, 0x0, 0x0, 0x80040000}};
...
START_TEST(test_mod147) {
  ...
  my_decimal decimal2 = {{0x55555555, 0x0, 0x0, 0x90000}};
  // -0.000000000
  my_decimal decimal_check = {{0x0, 0x0, 0x0, 0x80090000}};
...
START_TEST(test_mod149) {
  ...
  my_decimal decimal2 = {{0x811800, 0x0, 0x0, 0x30000}};
  // -7044.120
  my_decimal decimal_check = {{0x6B7C18, 0x0, 0x0, 0x80030000}};
...
START_TEST(test_mod151) {
  ...
  my_decimal decimal2 = {{0x1F40, 0x0, 0x0, 0x30000}};
  // -7.000
  my_decimal decimal_check = {{0x1B58, 0x0, 0x0, 0x80030000}};
...
START_TEST(test_mod153) {
  ...
  my_decimal decimal2 = {{0x3E9, 0x0, 0x0, 0x30000}};
  // -0.091
  my_decimal decimal_check = {{0x5B, 0x0, 0x0, 0x80030000}};
...
START_TEST(test_mod169) {
  // 7922816251426433759354395033.5
  my_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x10000}};
  // 79228162514264337593543950335
  my_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // 7922816251426433759354395033.5
...
START_TEST(test_mod181) {
  ...
  my_decimal decimal_check = {{0x18000000, 0x602F7FC3, 0x7CC4D1C3, 0x1C0000}};
...
START_TEST(test_mod187) {
  ...
  my_decimal decimal2 = {{0x0, 0x1, 0x0, 0x0}};
  // 2576980377.5
  my_decimal decimal_check = {{0xFFFFFFFF, 0x5, 0x0, 0x10000}};
...
START_TEST(test_mod191) {
  ...
  my_decimal decimal2 = {{0xFFFFFFFF, 0x1, 0x0, 0x0}};
  // 1825361100.5
  my_decimal decimal_check = {{0x3FFFFFFD, 0x4, 0x0, 0x10000}};
...
START_TEST(test_mod193) {
  ...
  my_decimal decimal2 = {{0x5, 0x0, 0x0, 0x0}};
  // 3.5
  my_decimal decimal_check = {{0x23, 0x0, 0x0, 0x10000}};
...
START_TEST(test_mod197) {
  ...
  my_decimal decimal_check = {{0xD8030250, 0x3BF7D56C, 0x35047BC5, 0x1C0000}};
...
START_TEST(test_mod199) {
  ...
  my_decimal decimal_check = {{0x64CCCCCC, 0x2A04505E, 0x3D44825A, 0x1C0000}};
